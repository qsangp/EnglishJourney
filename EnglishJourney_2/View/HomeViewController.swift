...
extension HomeViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        switch section {
        case 0:
            header.configure(mainLabel: "   What to learn", addSecondLabel: false, addSwitch: false)
            return header
        case 1:
            header.configure(mainLabel: "   Random", addSecondLabel: false, addSwitch: true)
            return header
        case 2:
            header.configure(mainLabel: "   To Review", addSecondLabel: true, addSwitch: false)
...
class HeaderView: UIView {
    ...
    public func configure(mainLabel: String, addSecondLabel: Bool, addSwitch: Bool) {
